...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'schedule_calendarpluginmodel', 'num_upcoming_events',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'schedule_calendarpluginmodel', 'num_upcoming_events')
    ...
    models = {
        ...
        'schedule.calendarpluginmodel': {
            'Meta': {'object_name': 'CalendarPluginModel', '_ormbases': ['cms.CMSPlugin']},
